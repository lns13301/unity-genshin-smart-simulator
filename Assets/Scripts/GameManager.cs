    ...
    public void SetDetailText()
    {
        ...
        if (LanguageManager.instance.language == Language.KOREAN)
        {
            ...
            detailContent.GetChild(1).GetComponent<Text>().text =
                GetColorText("용등의 춤 이벤트 기원", "9958b3") + " : " + GetColorText("74회차", RED_COLOR) + "까지 " + GetColorText("0.6%", RED_COLOR)
            ...
            detailContent.GetChild(2).GetComponent<Text>().text =
                GetColorText("용등의 춤 이벤트 기원", "9958b3") + " : 기본 " + GetColorText("5.1%", RED_COLOR) + ", "
        ...
        else
        {
            ...
            detailContent.GetChild(1).GetComponent<Text>().text =
                GetColorText("Event Wish \"Dance of Lanterns\"", "9958b3") + " : " + "It has a " + GetColorText("0.6%", RED_COLOR) + " probability up to " + GetColorText("74 times", RED_COLOR) + "."
            ...
            detailContent.GetChild(2).GetComponent<Text>().text =
            GetColorText("Event Wish \"Dance of Lanterns\"", "9958b3") + " : " + "It has a " + GetColorText("5.1%", RED_COLOR) + " probability up to " + GetColorText("4 times", RED_COLOR) + "."
